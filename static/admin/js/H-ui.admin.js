...
*/
var num=0,oUl=$("#min_title_list"),hide_nav=$("#my-tabNav");

/*获取顶部选项卡总长度*/
function tabNavallwidth(){
	var taballwidth=0,
		$tabNav = hide_nav.find(".acrossTab"),
		$tabNavWp = hide_nav.find(".my-tabNav-wp"),
		$tabNavitem = hide_nav.find(".acrossTab li"),
		$tabNavmore =hide_nav.find(".my-tabNav-more");
	if (!$tabNav[0]){return}
...
function creatIframe(href,titleName){
	var topWindow=$(window.parent.document),
		...
		$tabNavWp = topWindow.find(".my-tabNav-wp"),
		$tabNavmore =topWindow.find(".my-tabNav-more");
	var taballwidth=0;
...
$(function(){
	...
	$(".nav-toggle").click(function(){
		$(".my-aside").slideToggle();
	});
	$(".my-aside").on("click",".menu_dropdown dd li a",function(){
		if($(window).width()<768){
			$(".my-aside").slideToggle();
		}
	});
	...
	/*选项卡导航*/
	$(".my-aside").on("click",".menu_dropdown a",function(){
		Hui_admin_tab(this);
	});
	...
	/*换肤*/
	$("#my-skin .dropDown-menu a").click(function(){
